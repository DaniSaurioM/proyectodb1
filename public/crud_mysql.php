...
<body>
    ...
    <form action="crud_mysql.php" method="post">
    ...
    <table border="1">
        ...
        <tbody>
            ...
            foreach ($pdo_mysql->query($sql) as $row) {
                echo "<tr>";
                echo "<td>{$row['dpi']}</td>";
                ...
                // Otros campos...
                echo "<td><a href='editar_mysql.php?id={$row['dpi']}'>Editar</a> | <a href='borrar_mysql.php?id={$row['dpi']}'>Borrar</a></td>";
                echo "</tr>";
            }
            ?>
        </tbody>
    ...
    if (isset($_POST['crear'])) {
        ...
        $stmt_insert = $pdo_mysql->prepare($sql_insert);
